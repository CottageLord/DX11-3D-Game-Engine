...
namespace Rgph
{
	...
	public:
		...
		virtual std::shared_ptr<GPipeline::Bindable> YieldBindable();
		virtual std::shared_ptr<GPipeline::BufferResource> YieldBuffer();
	...
	public:
		...
		{}
		std::shared_ptr<GPipeline::BufferResource> YieldBuffer() override
		{
			if (linked)
			{
	...
	public:
		...
		void PostLinkValidate() const
		{}
		std::shared_ptr<GPipeline::Bindable> YieldBindable() override
		{
			return bind;
		}
	private:
