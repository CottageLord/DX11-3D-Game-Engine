...
public:
	...
	static IndexedTriangleList Make(std::optional<DynamicVertex::VertexLayout> layout = std::nullopt)
	{
		using Element = DynamicVertex::VertexLayout::ElementType;
		if (!layout)
		{
			layout = DynamicVertex::VertexLayout{}.Append(Element::Position3D);
		}
