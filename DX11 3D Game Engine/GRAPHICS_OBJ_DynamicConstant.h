...
#undef X
	...
	// raw layout is moved to LayoutPool (usually via Buffer::Make), and the internal layout
	// element tree is "delivered" (finalized and moved out). LayoutPool returns a baked
	...
	private:
		// this ctor used by LayoutPool to return cooked layouts
